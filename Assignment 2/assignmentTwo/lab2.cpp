...
void buildTree(BinTree&, ifstream&);      // Build Tree
void initArray(NodeData*[]);             // initialize array to NULL

//Precondtion: None
//Postcondition: BinTree class will have all of its methods tested
int main() {
...
//------------------------------- buildTree ----------------------------------
// Precondition: BinTree exists and is valid
// Postcondition: Tree will be built using contents of files
...
//------------------------------- initArray ----------------------------------
// Precondition: Array of NodeData pointers exist and are valid
// Postcondtion: Array of NodeData pointers will be initialized to NULL
